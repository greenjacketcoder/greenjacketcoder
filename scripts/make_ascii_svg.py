...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">greenjacketcoder@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'greenjacketcoder@github:~$ whoami <tspan fill="{INK}">greenjacketcoder</tspan></text>')
parts.append(f'<rect x="{PAD+400}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
